...
class TransactionDraftController extends GetxController
    with StateMixin<List<TransactionDraft>> {
  void getTransactionDraft() async {
    change(null, status: RxStatus.loading());
    SharedPreferences preferences = await SharedPreferences.getInstance();
    var idSales = preferences.getString("idSales");
    var token = preferences.getString("token");
    try {
      var result = await Transaction.getListDraftTransaction(idSales!, token!);
      if (result.isEmpty) {
